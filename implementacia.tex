...
Preto sme si zvolili prehľadnú \glqq krabičku\grqq ~(obrázok~\ref{img:userbox}).
...
Fundamentálny problém, ktorý tvorí významnú rolu v rôznych disciplínach ako sú rozpoznávanie vzorov, spracovanie obrazu, strojové učenie a štatistika sa nazýva problém
